...
from sibuchen_agents.core.streaming import StreamEvent, StreamEventType
from sibuchen_agents.core.lifecycle import LifecycleHook
...
class SimpleAgent(Agent):
    ...
    def run(self, input_text: str, **kwargs) -> str:
        ...
        if not self.enable_tool_calling or not self.tool_registry:
            ...
            self.add_message(SibuchenMessage("assistant", response_text or ""))
        ...
        # 保存到历史记录
        self.add_message(SibuchenMessage("user", input_text))
        self.add_message(SibuchenMessage("assistant", final_response or ""))
    ...
    def stream_run(self, input_text: str, **kwargs) -> Iterator[str]:
        ...
        # 保存完整对话到历史记录
        self.add_message(SibuchenMessage("user", input_text))
        self.add_message(SibuchenMessage("assistant", full_response))
