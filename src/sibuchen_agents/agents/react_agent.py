    ...
    def run(self, input_text: str, **kwargs) -> str:
        ...
        while current_step < self.max_steps:
            ...
            if action.startswith("Finish"):
                ...
                self.add_message(SibuchenMessage("assistant", final_answer))
            ...
            # 调用工具
            observation_resp = self.tool_registry.execute_tool(tool_name, tool_input)
            observation = observation_resp.text
