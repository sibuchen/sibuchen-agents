...
class OpenAIAdapter(BaseLLMAdapter):
    ...
    def invoke(self, messages: List[Dict], **kwargs) -> LLMResponse:
        ...
        try:
            ...
            raise SibuchenAgentsException(f"OpenAI API调用失败: {str(e)}")
    ...
    def stream_invoke(self, messages: List[Dict], **kwargs) -> Iterator[str]:
        ...
        try:
            ...
            raise SibuchenAgentsException(f"OpenAI API流式调用失败: {str(e)}")
    ...
    async def astream_invoke(self, messages: List[Dict], **kwargs) -> AsyncIterator[str]:
        ...
        try:
            ...
            raise SibuchenAgentsException(f"OpenAI API异步流式调用失败: {str(e)}")
    ...
    def invoke_with_tools(self, messages: List[Dict], tools: List[Dict],
        ...
        try:
            ...
            raise SibuchenAgentsException(f"OpenAI Function Calling调用失败: {str(e)}")
...
class AnthropicAdapter(BaseLLMAdapter):
    ...
    def invoke(self, messages: List[Dict], **kwargs) -> LLMResponse:
        ...
        try:
            ...
            raise SibuchenAgentsException(f"Anthropic API调用失败: {str(e)}")
    ...
    def stream_invoke(self, messages: List[Dict], **kwargs) -> Iterator[str]:
        ...
        try:
            ...
            raise SibuchenAgentsException(f"Anthropic API流式调用失败: {str(e)}")
    ...
    def invoke_with_tools(self, messages: List[Dict], tools: List[Dict], **kwargs) -> LLMToolResponse:
        ...
        try:
            ...
            raise SibuchenAgentsException(f"Anthropic工具调用失败: {str(e)}")
...
class GeminiAdapter(BaseLLMAdapter):
    ...
    def invoke(self, messages: List[Dict], **kwargs) -> LLMResponse:
        ...
        try:
            ...
            raise SibuchenAgentsException(f"Gemini API调用失败: {str(e)}")
    ...
    def stream_invoke(self, messages: List[Dict], **kwargs) -> Iterator[str]:
        ...
        try:
            ...
            raise SibuchenAgentsException(f"Gemini API流式调用失败: {str(e)}")
    ...
    def invoke_with_tools(self, messages: List[Dict], tools: List[Dict], **kwargs) -> LLMToolResponse:
        ...
        try:
            ...
            raise SibuchenAgentsException(f"Gemini工具调用失败: {str(e)}")
