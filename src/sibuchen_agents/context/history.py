...
class HistoryManager:
    ...
    # 追加消息
    manager.append(SibuchenMessage("hello", "user"))
    manager.append(SibuchenMessage("hi", "assistant"))
    ...
    def __init__(
        ...
        """
        self._history: List[SibuchenMessage] = []
        self.min_retain_rounds = min_retain_rounds
        self.compression_threshold = compression_threshold

    def append(self, message: SibuchenMessage) -> None:
        """追加消息（只追加，不编辑）
    ...
    def load_from_dict(self, data: Dict[str, Any]) -> None:
        ...
        """
        self._history = [
            SibuchenMessage.from_dict(msg_data)
