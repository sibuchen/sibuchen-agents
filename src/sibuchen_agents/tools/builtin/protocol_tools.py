...
- IM  Tool: 基于 nonebot2 库实现
"""

from typing import Dict, Any, List, Optional
from sibuchen_agents.tools.base import Tool, ToolParameter
import os
...
class MCPTool(Tool):
    ...
    def _create_builtin_server(self):
        ...
        try:
            ...
            server = FastMCP("SibuchenAgents-BuiltinServer")
            ...
            def greet(name: str = "World") -> str:
                """友好问候"""
                return f"Hello, {name}! 欢迎使用 SibuchenAgents MCP 工具！"
            ...
            def get_system_info() -> dict:
                ...
                return {
                    ...
                    "server_name": "SibuchenAgents-BuiltinServer",
                    "tools_count": 6
                }
    ...
    def _discover_tools(self):
        """发现MCP服务器提供的所有工具"""
        try:
            from sibuchen_agents.protocols.mcp.client import MCPClient
            import asyncio
...
class A2ATool(Tool):
    ...
    def run(self, parameters: Dict[str, Any]) -> str:
        ...
        """
        try:
            from sibuchen_agents.protocols.a2a.implementation import A2AClient, A2A_AVAILABLE
...
class ANPTool(Tool):
    ...
    def __init__(self, name: str = "anp", description: str = None, discovery=None, network=None):
        ...
        from sibuchen_agents.protocols.anp.implementation import ANPDiscovery, ANPNetwork
    ...
    def run(self, parameters: Dict[str, Any]) -> str:
        ...
        Returns:
            操作结果
        """
        from sibuchen_agents.protocols.anp.implementation import ServiceInfo
        ...
        try:
            if action == "register_service":
                ...
                service = ServiceInfo(service_id, service_type, endpoint, metadata=metadata)
