...
from sibuchen_agents.memory.storage.document_store import SQLiteDocumentStore
from sibuchen_agents.memory.storage.qdrant_store import QdrantVectorStore
...
class PerceptualMemory(BaseMemory):
    ...
    def __init__(self, config: MemoryConfig, storage_backend=None):
        ...
        base_collection = os.getenv("QDRANT_COLLECTION", "sibuchen_agents_vectors")
    ...
    def _encode_data(self, data: Any, modality: str) -> List[float]:
        ...
        encode_func: Callable = self.encoders.get(modality, self._default_encoder)
        vec = encode_func(data)
